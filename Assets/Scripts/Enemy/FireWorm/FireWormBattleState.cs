...
public class FireWormBattleState : EnemyState
{
    ...
    private int moveDir;
    public FireWormBattleState(Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName, Enemy_FireWorm _enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        this.enemy = _enemy;
    }
